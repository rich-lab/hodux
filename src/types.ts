import { FC, ComponentClass, PropsWithChildren, NamedExoticComponent } from 'react';
 ...
 */
export type HoduxConfigProps<T = any> = PropsWithChildren<{
 ...
 * Store selector type
 */
export interface Selector<Store, Selected = Store, OwnProps = {}> {
